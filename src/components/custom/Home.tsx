  ...
  return (
    <>
            ...
            >
              ...
              >
                <Stack
                  ...
                  gap={2}
                >
                  <img src='/images/profile.png' alt='' width={56} height={56} />
                  <Stack>
              ...
              I was initially scared for the first time trying NearU. However, I soon realized that the organized system made it easy to use. When I met with elderly patients, I felt proud to support them meaningfully.
              </Typography>
            </Stack>
            <Stack
              p={4}
            ...
            >
              ...
              >
                <Stack
                  ...
                  gap={2}
                >
                  <img src='/images/Jaemin-Cheong.png' alt='' width={56} height={56} style={{borderRadius: '100%'}}/>
                  <Stack>
                    <Typography component='div' color='#000' fontSize={14} fontWeight={600} fontFamily='Montserrat'>
                      {/* Yunji Noh */}
                      Jaemin Cheong
              ...
              <Typography component='p' color='#000' fontSize={15} fontWeight={500} fontFamily='Montserrat'>
              I hope to continue to use NearU even after I graduate. This is a great platform to support our community. I like how it targets specific problems in the ongoing society, and it is very trustworthy! I am also excited about the volunteer hours.
              </Typography>
            </Stack>
          </Stack>
        </Stack>
        ...
        >
          <Stack>
            ...
            >
              ...
              <EmailIcon width={20} sx={{color:"#55BDB3"}}/>
              ...
              <Stack flexDirection='row' alignItems='center' gap={1.5}>
              <HomeIcon width={20} sx={{color:"#55BDB3"}}/>
              <Typography pt={0.5} component='div' color='#fff' fontSize={15} fontWeight={400} fontFamily='Montserrat'>
              인천광역시 서구 경서동<br />
                834-128 청라달튼외국인학교
              </Typography>
      ...
      >
        ...
        >
          ...
          <Stack
            ...
            gap={3}
          >
            <Typography component='div' color='#ccc' fontSize={15} fontWeight={500} fontFamily='Montserrat' onClick={() => setOpen2(true)}>
              Terms of Usage and Conditions
            </Typography>
            <Typography component='div' color='#ccc' fontSize={15} fontWeight={500} fontFamily='Montserrat'>
              |
            </Typography>
            <Typography component='div' color='#ccc' fontSize={15} fontWeight={500} fontFamily='Montserrat' onClick={() => setOpen1(true)}>
              Privacy Policy
            </Typography>
          </Stack>
        </Stack>
      ...
      <Dialog open={open} onClose={() => setOpen(false)} maxWidth='sm' fullWidth>
        <DialogTitle>서비스 소개</DialogTitle>
        <DialogContent>
          <Typography align='center'>
            저희 NearU는 여러분에게 안전하고 간편한
            <br />
            병원 동행 서비스를 제공 드리고 싶습니다.
            <br />
            <br />
            각각 다양한 이유로 저희를 찾게 되셨겠지만
            <br />
            이유와 장소 상관 없이, 모든 병원에 서비스를 제공 할 수 있는 그날까지,
            <br />
            <br />
            저희도 언제나 함께 하며 발전해 나아가겠습니다.
          </Typography>
        </DialogContent>
        <DialogActions>
